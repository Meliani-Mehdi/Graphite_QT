...
"")
        ...
        icon8 = QIcon()
        icon8.addFile(u"assets/full-screen.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon9 = QIcon()
        icon9.addFile(u"assets/focus.png", QSize(), QIcon.Normal, QIcon.Off)
        self.focus.setIcon(icon9)
...
"background-color: rgb(23, 23, 23);")
        ...
        icon10 = QIcon()
        icon10.addFile(u"assets/buttons/types/plot.png", QSize(), QIcon.Normal, QIcon.Off)
        self.plot.setIcon(icon10)
        ...
        icon11 = QIcon()
        icon11.addFile(u"assets/buttons/types/Bar-Chart.png", QSize(), QIcon.Normal, QIcon.Off)
        self.histogram.setIcon(icon11)
        ...
        icon12 = QIcon()
        icon12.addFile(u"assets/buttons/types/Pie-Chart.png", QSize(), QIcon.Normal, QIcon.Off)
        self.piechart.setIcon(icon12)
        ...
        icon13 = QIcon()
        icon13.addFile(u"assets/buttons/types/fill_between.png", QSize(), QIcon.Normal, QIcon.Off)
        self.fill_between.setIcon(icon13)
        ...
        icon14 = QIcon()
        icon14.addFile(u"assets/buttons/types/stackplot.png", QSize(), QIcon.Normal, QIcon.Off)
        self.stackplot.setIcon(icon14)
