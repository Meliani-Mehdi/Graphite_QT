...
"")
        ...
        icon10 = QIcon()
        icon10.addFile(u"assets/pop.png", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        ...
        self.canv.setFrameShape(QFrame.Shape.StyledPanel)
        self.canv.setFrameShadow(QFrame.Shadow.Raised)
