...
"")
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 1374, 114))
        ...
        self.horizontalLayout_6.addWidget(self.passe)
...
"}")
    ...
    def retranslateUi(self, Graphite):
        ...
        self.passe.setToolTip(QCoreApplication.translate("Graphite", u"Bandpass", None))
